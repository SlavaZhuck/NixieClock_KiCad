...
// 3 - COVID 2019 (прокет ADM503 и poty)
...
byte FLIP_SPEED[] = {0, 100, 50, 40, 70, 70}; 
                                // количество эффектов
...
#define GEN               9     // - генератор - исправить
#define DOT               10    // - точка - исправить в v.1 подключение!!!! было подключено к 0
#define BACKLR            11    // - выход на красные светодиоды подсветки
#define BACKLG            6     // - выход на зелёные светодиоды подсветки - исправить, было 10
#define BACKLB            5     // - выход на голубые светодиоды подсветки - исправить, было 9
